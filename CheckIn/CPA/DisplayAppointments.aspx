...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true">
        <ContentTemplate>
            ...
            <div class="breadcrumbs" id="Div1" height="200px">
                ...
                <div class="nav-search" id="nav-search">
                    <asp:DropDownList ID="ddlSpeciality" CssClass="select2" Width="250px" Style="margin-bottom: 10px; padding-right: 10px;" ClientIDMode="Static" runat="server" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="True">
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlState" CssClass="select2" Width="200px" Style="margin-bottom: 10px; padding-right: 10px;" ClientIDMode="Static" runat="server" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="True">
                    </asp:DropDownList>

                    <asp:DropDownList ID="ddlCity" CssClass="select2" Style="margin-bottom: 10px;" ClientIDMode="Static" runat="server" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="True">
                        <asp:ListItem>-No Options-</asp:ListItem>
                    </asp:DropDownList>

                    <input visible="False" type="text" id="txtCity" runat="server" value="Enter City" autocomplete="off" class="input-small nav-search-input" onclick="if (this.value == 'Enter City') { this.value = '' }"
