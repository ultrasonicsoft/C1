...
{
    public partial class ViewPastAppointment : System.Web.UI.Page
    {
        #region Members
        ...
        private void RefreshSearchResult()
        {
           ...
           // var result = BusinessLogic.GetAllPastAppointmentForCustomer(int.Parse(Session["userID"].ToString()));
            var result=BusinessLogic.GetPastSCheduleCPACustomerDetails2(userID);
        ...
        protected void gvAppointments_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //{
            //    FillUserPastAppointments(e);
            //}
        }

        //private void FillUserPastAppointments(GridViewRowEventArgs e)
        //{
        //    Label cpaID = (Label)e.Row.FindControl("lblCPAID");

        //    if (cpaID != null)// && tempDate != null)
        //    {
        //       DataSet result = BusinessLogic.GetPastCPACustomerDetails(cpaID.Text, userId);
        ...
        //        result = BusinessLogic.GetPastCPACustomerSchedule(cpaID.Text, userId);
        //        if (result != null)
        //        {
